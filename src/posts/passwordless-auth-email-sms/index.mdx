...
slug: passwordless-auth-email-sms
date: 12-10-2021
featureImage: feature.png
excerpt: Passwordless (OTP - One Time Password) authentication with Email, SMS and Github-OAuth using Twilio & Nodemailer
---
...
📍 Complete Playlist for reference : [Link](https://www.youtube.com/playlist?list=PLmrjGoFojRrnV3orR-Fv6Ov4PjinfG9Cn)

📍 Final code: [Link](https://github.com/pineapple45/passwordless-auth-email-sms)
